...
function cube(s) {
    ...
    function rotate(angle, axis) {
        ...
        for (i = 0; i < cubeTriangleNormals.length; i++) {
            var t = [0, 0, 0];
            for (var j = 0; j < 3; j++)
                for (var k = 0; k < 3; k++)
                    t[j] += mat[j][k] * cubeTriangleNormals[i][k] / ss[k];
            for (var j = 0; j < 3; j++) cubeTriangleNormals[i][j] = t[j];
        };
    }
        ...
        for (var i = 0; i < sphereVertexCoordinates.length; i++) {
            ...
            for (var j = 0; j < 3; j++)
                for (var k = 0; k < 3; k++) {
                    ...
                    v[j] += mat[j][k] * sphereNormals[i][k] / ss[k];
                };
            for (var j = 0; j < 3; j++) {
